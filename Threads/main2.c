...
int main (int argc, char *argv[]) {
  ...
  int delta = 0;
  delta = infoData->totalLinhas[1]/4;
  ...
  printf("Tempo de execução (Leitura + Execucao das 4 Threads):  %.6f segundos\n", tempoPercorrido);
  ...
  arquivo = fopen("populacao_regiao2.txt", "w");
