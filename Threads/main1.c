...
int main (int argc, char *argv[]) {
  ...
  printf("Tempo de execução (Leitura + Execucao das 2 Threads):  %.6f segundos\n", tempoPercorrido);
  ...
  arquivo = fopen("populacao_regiao1.txt", "w");
